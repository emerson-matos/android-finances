package com.github.emerson.financas.debug.kotlin
...
class EmailPasswordActivity : BaseActivity(), View.OnClickListener {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.continueToFinanceApp.setOnClickListener(this)
    ...
    private fun updateUI(user: FirebaseUser?) {
        ...
        if (user != null) {
            ...
            binding.continueToFinanceApp.visibility = View.VISIBLE
