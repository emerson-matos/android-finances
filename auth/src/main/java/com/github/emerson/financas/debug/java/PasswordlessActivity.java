...
import com.github.emerson.financas.debug.databinding.ActivityPasswordlessBinding;
...
public class PasswordlessActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == R.id.passwordlessSendEmailButton) {
            onSendLinkClicked();
        } else if (id == R.id.passwordlessSignInButton) {
            onSignInClicked();
