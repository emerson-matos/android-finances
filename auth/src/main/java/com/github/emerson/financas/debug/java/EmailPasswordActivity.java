...
package com.github.emerson.financas.debug.java;
...
import com.github.emerson.financas.debug.R;
import com.github.emerson.financas.debug.databinding.ActivityEmailpasswordBinding;
...
public class EmailPasswordActivity extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBinding.continueToFinanceApp.setOnClickListener(this);
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            mBinding.continueToFinanceApp.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.emailCreateAccountButton) {
            ...
            reload();
        } else if (i == R.id.continueToFinanceApp){
            finish();
        }
    }
}
