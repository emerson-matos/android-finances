...
class ExpenseData(@SerializedName("expenseId") val id: Long = -1L,
                  ...
                  @SerializedName("trasactionDate") val date: Date = Date(Random.nextLong(0, System.currentTimeMillis())),
                  @SerializedName("value") val value: BigDecimal = BigDecimal.valueOf(Random.nextDouble(0.0,1000.00)),
